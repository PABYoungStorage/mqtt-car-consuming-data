...
def callback(ch, method, properties, body):
    ...
    channel.basic_publish(exchange='', routing_key='car_data', body=json.dumps(
            {"UltFront": UltFront, "UltFrontData": UltFrontdata}))
...
if __name__ == "__main__":
    ...
    connection = pika.BlockingConnection(
        pika.ConnectionParameters(host='192.168.1.14', port=5672, virtual_host='/', credentials=cred))
    ...
    # this threading part for to detect
